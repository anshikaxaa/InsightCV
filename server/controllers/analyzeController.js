...
const analyzeCVMatch = async (req, res) => {
  try {
    ...
    const prompt = `You are an expert HR analyst specializing in CV and job description matching. Provide detailed, actionable insights.
...
const getCVInsights = async (req, res) => {
  try {
    ...
    const prompt = `You are an expert CV analyst. Provide comprehensive insights and actionable recommendations.
...
const getJDAnalysis = async (req, res) => {
  try {
    ...
    const prompt = `You are an expert job market analyst. Provide comprehensive job description analysis and insights.
...
const generateSuggestions = async (req, res) => {
  try {
    ...
    switch (analysisType) {
      case 'skills':
        prompt = `You are a career development expert. Provide actionable, specific improvement suggestions.
